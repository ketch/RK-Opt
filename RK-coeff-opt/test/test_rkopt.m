...
function test_SSP32
tol = 1.e-14;
rk=rk_opt(3,2,'erk','ssp','startvec','smart','writeToFile',0);
...
function test_SSP43
rk=rk_opt(4,3,'erk','ssp','startvec','smart','writeToFile',0);
b = [1./6 1./6 1./6 1./2]';
r = 2.;
...
rk=rk_opt(2,2,'sdirk','ssp','startvec','random','writeToFile',0);
b = [1./2 1./2]';
r = 4.;
...
tol = 1.e-7;
rk=rk_opt(2,2,'dirk','ssp','startvec','smart','writeToFile',0);
...
rk=rk_opt(2,2,'erk','acc','startvec',x,'writeToFile',0);
b = [0.25 0.75]';
...
tol = 1.e-14;
rk=rk_opt(3,2,'erk','ssp','startvec','smart','np',2,'writeToFile',0);
A = [0 0 0; 0.5 0 0; 0.5 0.5 0];
r = 2.;
...
rk=rk_opt(4,3,'erk','ssp','startvec','smart','np',1,'writeToFile',0);
b = [1./6 1./6 1./6 1./2]';
r = 2.;
...
rk=rk_opt(4,3,'erk','ssp','startvec','smart','np',2,'writeToFile',0);
b = [1./6 1./6 1./6 1./2]';
r = 2.;
...
rk=rk_opt(2,2,'sdirk','ssp','startvec','random','np',1,'writeToFile',0);
b = [1./2 1./2]';
r = 4.;
...
rk=rk_opt(2,2,'sdirk','ssp','startvec','random','np',2,'writeToFile',0);
b = [1./2 1./2]';
r = 4.;
...
tol = 1.e-7;
rk=rk_opt(2,2,'dirk','ssp','startvec','smart','np',1,'writeToFile',0);
...
tol = 1.e-7;
rk=rk_opt(2,2,'dirk','ssp','startvec','smart','np',2,'writeToFile',0);
...
x=[0.117831902493812 0.187227391881097   0.812772608118903  -0.099952256513284 -0.010000000000000];
rk=rk_opt(2,2,'erk','acc','startvec',x,'np',1,'writeToFile',0);
b = [0.25 0.75]';
...
x=[0.117831902493812 0.187227391881097   0.812772608118903  -0.099952256513284 -0.010000000000000];
rk=rk_opt(2,2,'erk','acc','startvec',x,'np',2,'writeToFile',0);
b = [0.25 0.75]';
