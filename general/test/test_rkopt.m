...
function test_SDIRK_SSP22_loop
...
tol = 1.e-14;
rk=rk_opt(3,2,'erk','ssp',[],[],'smart',0,1,0);
A = [0 0 0; 0.5 0 0; 0.5 0.5 0];
r = 2.;
...
tol = 1.e-14;
rk=rk_opt(3,2,'erk','ssp',[],[],'smart',0,1,1);
A = [0 0 0; 0.5 0 0; 0.5 0.5 0];
r = 2.;
...
rk=rk_opt(4,3,'erk','ssp',[],[],'smart',0,1,0);
b = [1./6 1./6 1./6 1./2]';
r = 2.;
...
rk=rk_opt(4,3,'erk','ssp',[],[],'smart',0,1,1);
b = [1./6 1./6 1./6 1./2]';
r = 2.;
...
rk=rk_opt(2,2,'sdirk','ssp',[],[],'random',0,1,0);
b = [1./2 1./2]';
r = 4.;
...
rk=rk_opt(2,2,'sdirk','ssp',[],[],'random',0,1,1);
b = [1./2 1./2]';
r = 4.;
...
tol = 1.e-7;
rk=rk_opt(2,2,'dirk','ssp',[],[],'smart',0,1,0);
...
tol = 1.e-7;
rk=rk_opt(2,2,'dirk','ssp',[],[],'smart',0,1,1);
